...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return VERSION; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return getDataDetail; });
/* unused harmony export formatArrayBuffer */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return isArrayBuffer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return sendMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return createLogger; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return getUserAgentHeader; });
/* unused harmony export constructUserAgent */
/* harmony import */ var _ILogger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _Loggers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
...
/* harmony import */ var _TextMessageFormat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
var HandshakeProtocol = /** @class */ (function () {
    ...
    HandshakeProtocol.prototype.parseHandshakeResponse = function (data) {
        ...
        var messageData;
        var remainingData;
        if (Object(_Utils__WEBPACK_IMPORTED_MODULE_1__[/* isArrayBuffer */ "i"])(data) || (typeof Buffer !== "undefined" && data instanceof Buffer)) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var signalR = __webpack_require__(12);
var divMessages = document.querySelector("#imitatetextbox");
var Filename = document.querySelector("#filename");
var btnCreateFile = document.querySelector("#btnCreateFile");
var btnDeleteFile = document.querySelector("#btnDeleteFile");
var btnRenameFile = document.querySelector("#btnRenameFile");
var btnAppenedFileName = document.querySelector("#btnAppenedFileName");
var model = document.querySelector("#testmodel");
var username = new Date().getTime();
var connection = new signalR.HubConnectionBuilder()
    .withUrl("http://127.0.0.1:7655/commHub").withAutomaticReconnect()
    .build();
connection.on("ReceiveMessage", function (FileOpsModel) {
...
connection.on("HandleError", function (HandleError) {
    var messages = document.createElement("div");
    messages.innerHTML =
...
var FetchHttpClient_FetchHttpClient = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this.logger.log(ILogger["a" /* LogLevel */].Warning, "Error from HTTP request. " + e_1 + ".");
                        throw e_1;
                    case 4:
                        if (timeoutId) {
    ...
    FetchHttpClient.prototype.getCookieString = function (url) {
        var cookies = "";
        if (Utils["c" /* Platform */].isNode && this.jar) {
...
var DefaultHttpClient_DefaultHttpClient = /** @class */ (function (_super) {
    ...
    function DefaultHttpClient(logger) {
        var _this = _super.call(this) || this;
        if (typeof fetch !== "undefined" || Utils["c" /* Platform */].isNode) {
            _this.httpClient = new FetchHttpClient_FetchHttpClient(logger);
        }
...
var HandshakeProtocol = __webpack_require__(4);
            ...
            return HubConnection_generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        if (this.connectionState !== HubConnectionState.Reconnecting) {
                            this.logger.log(ILogger["a" /* LogLevel */].Debug, "Connection moved to the '" + this.connectionState + "' from the reconnecting state during reconnect attempt. Done reconnecting.");
            ...
            return LongPollingTransport_generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = Object(Utils["h" /* getUserAgentHeader */])(), name = _b[0], value = _b[1];
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (response.statusCode === 204) {
                            ...
                            if (response.content) {
                                this.logger.log(ILogger["a" /* LogLevel */].Trace, "(LongPolling transport) data received. " + Object(Utils["g" /* getDataDetail */])(response.content, this.logMessageContent) + ".");
                                if (this.onreceive) {
    ...
    LongPollingTransport.prototype.send = function (data) {
        return LongPollingTransport_awaiter(this, void 0, void 0, function () {
            return LongPollingTransport_generator(this, function (_a) {
                ...
                return [2 /*return*/, Object(Utils["j" /* sendMessage */])(this.logger, "LongPolling", this.httpClient, this.url, this.accessTokenFactory, data, this.logMessageContent, this.withCredentials, this.headers)];
            });
        });
    };
            ...
            return LongPollingTransport_generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        headers = {};
                        _a = Object(Utils["h" /* getUserAgentHeader */])(), name_1 = _a[0], value = _a[1];
                ...
                switch (_a.label) {
                    ...
                    case 2: return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            if (Utils["c" /* Platform */].isBrowser || Utils["c" /* Platform */].isWebWorker) {
                                ...
                                var _a = Object(Utils["h" /* getUserAgentHeader */])(), name_1 = _a[0], value = _a[1];
                                headers[name_1] = value;
                            ...
                            try {
                                eventSource.onmessage = function (e) {
                                    if (_this.onreceive) {
                                        try {
                                            _this.logger.log(ILogger["a" /* LogLevel */].Trace, "(SSE transport) data received. " + Object(Utils["g" /* getDataDetail */])(e.data, _this.logMessageContent) + ".");
    ...
    ServerSentEventsTransport.prototype.send = function (data) {
        return ServerSentEventsTransport_awaiter(this, void 0, void 0, function () {
            return ServerSentEventsTransport_generator(this, function (_a) {
                ...
                return [2 /*return*/, Object(Utils["j" /* sendMessage */])(this.logger, "SSE", this.httpClient, this.url, this.accessTokenFactory, data, this.logMessageContent, this.withCredentials, this.headers)];
            });
        });
    };
...
var WebSocketTransport_WebSocketTransport = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2: return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            webSocket.onmessage = function (message) {
                                _this.logger.log(ILogger["a" /* LogLevel */].Trace, "(WebSockets transport) data received. " + Object(Utils["g" /* getDataDetail */])(message.data, _this.logMessageContent) + ".");
                                if (_this.onreceive) {
                                    try {
    ...
    WebSocketTransport.prototype.send = function (data) {
        if (this.webSocket && this.webSocket.readyState === this.webSocketConstructor.OPEN) {
            this.logger.log(ILogger["a" /* LogLevel */].Trace, "(WebSockets transport) sending data. " + Object(Utils["g" /* getDataDetail */])(data, this.logMessageContent) + ".");
...
var HttpConnection_HttpConnection = /** @class */ (function () {
    function HttpConnection(url, options) {
        ...
        Utils["a" /* Arg */].isRequired(url, "url");
        this.logger = Object(Utils["f" /* createLogger */])(options.logger);
        ...
        return HttpConnection_awaiter(this, void 0, void 0, function () {
            ...
            return HttpConnection_generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        e_2 = _a.sent();
                        this.logger.log(ILogger["a" /* LogLevel */].Error, "HttpConnection.transport.stop() threw error '" + e_2 + "'.");
                        this.stopConnection();
                        return [3 /*break*/, 8];
                    case 8:
        ...
        return HttpConnection_awaiter(this, void 0, void 0, function () {
            ...
            return HttpConnection_generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 12:
                        e_3 = _a.sent();
                        this.logger.log(ILogger["a" /* LogLevel */].Error, "Failed to start the connection: " + e_3);
                        this.connectionState = "Disconnected" /* Disconnected */;
                        this.transport = undefined;
            ...
            return HttpConnection_generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        _a = Object(Utils["h" /* getUserAgentHeader */])(), name = _a[0], value = _a[1];
                        headers[name] = value;
                    ...
                    case 5:
                        e_4 = _b.sent();
                        this.logger.log(ILogger["a" /* LogLevel */].Error, "Failed to complete negotiation with the server: " + e_4);
    ...
    HttpConnection.prototype.constructTransport = function (transport) {
        switch (transport) {
            case HttpTransportType.WebSockets:
                ...
                return new WebSocketTransport_WebSocketTransport(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || false, this.options.WebSocket, this.options.headers || {});
            case HttpTransportType.ServerSentEvents:
                if (!this.options.EventSource) {
                    throw new Error("'EventSource' is not supported in your environment.");
                }
                return new ServerSentEventsTransport_ServerSentEventsTransport(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || false, this.options.EventSource, this.options.withCredentials, this.options.headers || {});
            case HttpTransportType.LongPolling:
                return new LongPollingTransport_LongPollingTransport(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || false, this.options.withCredentials, this.options.headers || {});
            default:
    ...
    HttpConnection.prototype.stopConnection = function (error) {
        ...
        if (this.connectionState === "Connecting" /* Connecting */) {
            this.logger.log(ILogger["a" /* LogLevel */].Warning, "Call to HttpConnection.stopConnection(" + error + ") was ignored because the connection is still in the connecting state.");
        ...
        if (this.sendQueue) {
            this.sendQueue.stop().catch(function (e) {
                _this.logger.log(ILogger["a" /* LogLevel */].Error, "TransportSendQueue.stop() threw error '" + e + "'.");
            });
...
var Loggers = __webpack_require__(2);

// EXTERNAL MODULE: ./node_modules/@microsoft/signalr/dist/esm/TextMessageFormat.js
var TextMessageFormat = __webpack_require__(3);
...
var HubConnectionBuilder_HubConnectionBuilder = /** @class */ (function () {
    ...
    HubConnectionBuilder.prototype.withUrl = function (url, transportTypeOrOptions) {
        Utils["a" /* Arg */].isRequired(url, "url");
        Utils["a" /* Arg */].isNotEmpty(url, "url");
        this.url = url;
...
/* concated harmony reexport AbortError */__webpack_require__.d(__webpack_exports__, "AbortError", function() { return AbortError; });
/* concated harmony reexport HttpError */__webpack_require__.d(__webpack_exports__, "HttpError", function() { return HttpError; });
...
/* concated harmony reexport HttpClient */__webpack_require__.d(__webpack_exports__, "HttpClient", function() { return HttpClient; });
/* concated harmony reexport HttpResponse */__webpack_require__.d(__webpack_exports__, "HttpResponse", function() { return HttpResponse; });
/* concated harmony reexport DefaultHttpClient */__webpack_require__.d(__webpack_exports__, "DefaultHttpClient", function() { return DefaultHttpClient_DefaultHttpClient; });
/* concated harmony reexport HubConnection */__webpack_require__.d(__webpack_exports__, "HubConnection", function() { return HubConnection_HubConnection; });
/* concated harmony reexport HubConnectionState */__webpack_require__.d(__webpack_exports__, "HubConnectionState", function() { return HubConnectionState; });
/* concated harmony reexport HubConnectionBuilder */__webpack_require__.d(__webpack_exports__, "HubConnectionBuilder", function() { return HubConnectionBuilder_HubConnectionBuilder; });
/* concated harmony reexport MessageType */__webpack_require__.d(__webpack_exports__, "MessageType", function() { return MessageType; });
/* concated harmony reexport LogLevel */__webpack_require__.d(__webpack_exports__, "LogLevel", function() { return ILogger["a" /* LogLevel */]; });
/* concated harmony reexport HttpTransportType */__webpack_require__.d(__webpack_exports__, "HttpTransportType", function() { return HttpTransportType; });
/* concated harmony reexport TransferFormat */__webpack_require__.d(__webpack_exports__, "TransferFormat", function() { return TransferFormat; });
/* concated harmony reexport NullLogger */__webpack_require__.d(__webpack_exports__, "NullLogger", function() { return Loggers["a" /* NullLogger */]; });
/* concated harmony reexport JsonHubProtocol */__webpack_require__.d(__webpack_exports__, "JsonHubProtocol", function() { return JsonHubProtocol_JsonHubProtocol; });
/* concated harmony reexport Subject */__webpack_require__.d(__webpack_exports__, "Subject", function() { return Subject_Subject; });
/* concated harmony reexport VERSION */__webpack_require__.d(__webpack_exports__, "VERSION", function() { return Utils["e" /* VERSION */]; });
// Copyright (c) .NET Foundation. All rights reserved.
// Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
